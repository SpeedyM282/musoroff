...
export const Hero = () => {
    return (
        <section className='p-0 sm:p-20 flex justify-center items-center relative mt-20 sm:mt-5'>
            <div
                className='max-w-[1260px] mx-5 w-full h-[450px] xl:h-[550px] rounded-3xl relative'
            ...
            >
                ...
                <Image src={musorMan} alt='Man' className='absolute left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-5 lg:left-20 xl:left-40 bottom-0 h-[110%] w-[90%] min-w-[290px] max-w-[300px] sm:max-w-[500] sm:w-[250px] xl:w-[370px] z-10' />
                ...
                <div className='bg-white px-5 sm:px-10 py-3 sm:py-5 rounded-4xl absolute z-30 right-20 bottom-8 sm:bottom-20 w-56 sm:w-72 lg:w-96 xl:w-[550px]'>
                    <p className='text-xl lg:text-2xl xl:text-4xl font-bold text-[#212121]'>Ежемесячная<br /> подписка</p>
                </div>

                <div className='bg-[#212121] px-5 py-3 sm:px-7 sm:py-5 rounded-4xl absolute z-30 -right-5 lg:right-[6%] xl:right-0 xl:bottom-4 sm:bottom-7 -bottom-3'>
